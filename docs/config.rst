...
If you host TileServer GL in a folder other than the server root, include the url_prefix to ensure any autogenerated URLs include the correct path. e.g. https://www.example.com/url_prefix/styles.json
